...
var groupsResource = schema.GroupVersionResource{Group: "authentication.appscode.com", Version: "v1alpha1", Resource: "groups"}

var groupsKind = schema.GroupVersionKind{Group: "authentication.appscode.com", Version: "v1alpha1", Kind: "Group"}
...
func (c *FakeGroups) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
	_, err := c.Fake.
		Invokes(testing.NewDeleteActionWithOptions(groupsResource, c.ns, name, opts), &v1alpha1.Group{})
