...
import (
	...
	v1alpha1 "go.bytebuilders.dev/kube-auth-manager/apis/authentication/v1alpha1"
	"go.bytebuilders.dev/kube-auth-manager/client/clientset/versioned/scheme"
...
// AuthenticationV1alpha1Client is used to interact with features provided by the authentication.appscode.com group.
type AuthenticationV1alpha1Client struct {
	restClient rest.Interface
}

func (c *AuthenticationV1alpha1Client) Groups(namespace string) GroupInterface {
	return newGroups(c, namespace)
}

func (c *AuthenticationV1alpha1Client) Users(namespace string) UserInterface {
